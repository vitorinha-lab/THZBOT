...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:theuzinmaker\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=+151366923806:+1 (513) 669-2380\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD THZ BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] theuzinmaker? Este é um recurso especial para o theuzinmaker ❌',
					ownerB: '[❗] theuzinmaker? Este é um recurso especial para o theuzinmaker ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de theuzinmaker. Registre-se para fazer amizade com o bot thz por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar theuzinmaker|17\n\n──「 THZ BOT 」──`,
			...
			const ownerNumber = ["15136692380@s.whatsapp.net"] // replace this with your number
			...
			const premium = ["15136692380@s.whatsapp.net","5519971528262@s.whatsapp.net","994406551396@s.whatsapp.net","559288095981@s.whatsapp.net","5512992208103@s.whatsapp.net"] 
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS THZ BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @theuzinmaker domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o theuzinmaker ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do 𝙏𝙃𝙀𝙐𝙕𝙄𝙉𝙈𝘼𝙆𝙀𝙍:*\n\n abre.ai/theuzinmaker'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
